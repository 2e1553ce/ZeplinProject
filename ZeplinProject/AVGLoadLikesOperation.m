...
@interface AVGLoadLikesOperation ()
...
@implementation AVGLoadLikesOperation
...
- (void)main {
    ...
    NSString *urlBaseString = @"https://api.flickr.com/services/rest/?method=flickr.photos.getFavorites&api_key=c55f5a419863413f77af53764f86bd66&nojsoncallback=1&format=json&";
